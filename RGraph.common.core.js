...
{var prop=obj.properties;var co=obj.context;var ca=obj.canvas;var gutterLeft=obj.gutterLeft,gutterRight=obj.gutterRight,gutterTop=obj.gutterTop,gutterBottom=obj.gutterBottom,xaxispos=prop['chart.xaxispos'],graphArea=ca.height-gutterTop-gutterBottom,halfGraphArea=graphArea/2,offsetx=prop['chart.variant.threed.offsetx'],offsety=prop['chart.variant.threed.offsety']
if(!prop['chart.noaxes']&&!prop['chart.noyaxis']){RG.path(co,['b','m',gutterLeft,gutterTop,'l',gutterLeft+offsetx,gutterTop-offsety,'l',gutterLeft+offsetx,ca.height-gutterBottom-offsety,'l',gutterLeft,ca.height-gutterBottom]);}
if(xaxispos==='center'){RG.path(co,['m',gutterLeft,gutterTop+halfGraphArea,'l',gutterLeft+offsetx,gutterTop+halfGraphArea-offsety,'l',ca.width-gutterRight+offsetx,gutterTop+halfGraphArea-offsety,'l',ca.width-gutterRight,gutterTop+halfGraphArea,'c','s','#aaa','f','#ddd']);}else{RG.path(co,['m',gutterLeft,ca.height-gutterBottom,'l',gutterLeft+offsetx,ca.height-gutterBottom-offsety,'l',ca.width-gutterRight+offsetx,ca.height-gutterBottom-offsety,'l',ca.width-gutterRight,ca.height-gutterBottom,'c','s','#aaa','f','#ddd']);}};RG.strokedCurvyRect=function(co,x,y,w,h)
